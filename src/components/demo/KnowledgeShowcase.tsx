...
/**
 * A publicly-accessible demo that crawls a website (and its subdomains) to build a knowledge base.
 * Uses a DEMO_TENANT_ID from env to segregate demo data.
 */
export function KnowledgeShowcase() {
  ...
  const DEMO_TENANT_ID =
    ...
    "00000000-0000-0000-0000-000000000000"; // replace with your public demo tenant ID
  ...
  async function runDemo() {
    ...
    // Increment progress to 90% while crawling
    const interval = setInterval(() => {
      setDemoProgress((p) => Math.min(p + 5, 90));
    }, 400);
    ...
    <div className="space-y-12">
      <div className="text-center space-y-3">
        ...
        <p className="text-muted-foreground max-w-xl mx-auto">
          Our AI crawls your site and any subdomain, extracts business hours,
          services, pricing, and contact details, and builds a searchable
          knowledge base.
        </p>
      </div>
          ...
          <div className="flex flex-col md:flex-row gap-3">
            <div className="flex-1">
              ...
              <p className="text-xs text-muted-foreground mt-1">
                AI extracts business hours, services, contact info, and creates
                smart knowledge chunks.
              </p>
            </div>
          ...
          {info && (
            <div className="space-y-6 pt-4">
              ...
              <div className="p-4 rounded-xl bg-gradient-to-br from-green-50 to-emerald-100 dark:from-green-900 dark:to-emerald-800">
                ...
                <p className="text-sm">
                  AI can now answer questions about your hours, services, and
